...
data class EPDTemplate(
    ...
    @SerializedName("width") val width: String? = "1920", // 1920 todo: Output image size
    @SerializedName("height") val height: String? = "1080", // 1080 todo: Output image size
    @SerializedName("images") val images: List<EPDImage?>? = listOf(),
    @SerializedName("name") val name: String? = "",
    @SerializedName("orientation") val orientation: String? = "LANDSCAPE", // LANDSCAPE
    @SerializedName("texts") val texts: List<EPDText?>? = listOf(),
...
data class EPDImage(
    ...
    @SerializedName("width") val width: String? = "960", // 960 todo: image size
    @SerializedName("height") val height: String? = "1080", // 1080 todo: image size
    ...
    @SerializedName("positionX") val positionX: String? = "0", // 0 todo: image location
    @SerializedName("positionY") val positionY: String? = "0", // 0 todo: image location
